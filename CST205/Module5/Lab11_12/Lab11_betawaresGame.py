...
def roomone():
  ...
  while true:
    direction = raw_input("Please choose a room (lt) will take you to The Room of The Deep, (fd) will take you to the Room of Questionnaire, (rt) will take you to the Locker Room, (bk) will take you back the way you entered the game, or (vw) to view the object in the center of the room: ")
    if direction == "rt":
      room2()
      break
...
def room2():
    ...
    print("This room has one door which is behind you and there is also a locker in front of you.")
    
    #Get what the user wants to do
    userActivity = raw_input("Would you like to leave the way you came? ").lower()
